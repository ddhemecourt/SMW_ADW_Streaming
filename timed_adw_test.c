...
{
        /* THIS IS WHERE WE SET THE PERIOD OF THE THREAD TASK */
...
void *simple_cyclic_task(int *sock)
{
	...
	struct adw_s adw0 = {true, false, true, false, false, false, false, 0, 0, 0, 0, 0.00004,0};	
	char *adw_word_0 = malloc(sizeof(char *)*33);
	adw_constructor(adw_word_0,adw0);

	struct adw_s adw1 = {true, false, true, false, false, false, false, 0, 0, 0, 1, 0.00008, 0};	
